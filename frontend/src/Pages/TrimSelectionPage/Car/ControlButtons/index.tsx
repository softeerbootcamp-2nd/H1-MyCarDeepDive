...
function ControlButtons({ rotation, setRotation }: ControlButtonsProps) {
  return (
    <div className='absolute top-24 left-[10%] flex flex-col gap-2 z-40'>
      <button className='w-[52px] h-[52px] shadow-md bg-grey-1000 bg-opacity-80 rounded px-2.5 flex justify-between items-center hover:w-24 group transition-width duration-300'>
      ...
      <button
        className='w-[52px] h-[52px] shadow-md bg-grey-1000 bg-opacity-80 rounded px-2.5 flex justify-between items-center hover:w-24 group transition-width duration-300'
