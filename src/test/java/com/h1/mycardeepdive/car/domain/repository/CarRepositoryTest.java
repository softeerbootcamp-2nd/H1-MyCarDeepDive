...
class CarRepositoryTest {
    ...
    public void testSameIdUpdate() throws Exception {
        // given
        Car car1 =
                Car.builder().name("그랜저IG1").price(1000000000).comment("매우 좋은 현대차").build();
        carRepository.save(car1);

        // when
        Car car2 =
                Car.builder().id(car1.getId()).name("그랜저IG2").price(1000000000).comment("매우 좋은 현대차").build();
    ...
    public void saveNoIdMember() throws Exception {
        ...
        // when
        Car car2 =
                Car.builder().name("그랜저IG2").price(1000000000).comment("매우 좋은 현대차").build();
        carRepository.save(car2);
